...
document.getElementById('fileInput').addEventListener('change', async function(e) {
    ...
    try {
        ...
        const response = await fetch('https://emotion-recognition-webapp-production.up.railway.app/upload', {
            method: 'POST',
            body: formData
        });
...
document.querySelectorAll('#emotionDropdown a').forEach(item => {
    item.addEventListener('click', function(e) {
        ...
        fetch('https://emotion-recognition-webapp-production.up.railway.app/rephrase', {
            method: 'POST',
...
function analyzeEmotion(rephrasedText = null) {
    ...
    fetch('https://emotion-recognition-webapp-production.up.railway.app/predict_emotion', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
